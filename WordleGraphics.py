"""
graphical display for the Wordle.
"""
...
class WordleGWindow:
    ...
    def __init__(self):
        """Creates and display the Wordle graphics window."""
    ...
    def add_enter_listener(self, fn):
        """" specifies a callback function for ENTER key """
        self._enter_listeners.append(fn)

    def show_message(self, msg, color="Black"):
        """ shows a mesage below the squares """
